    ...
    <div>
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Abdallah Awadalla | Full-Stack Software Engineer"
          />
        </Head>
        <TransitionEffect />

        <main className="w-full mb- flex flex-col items-center justify-center overflow-hidden dark:text-light">
