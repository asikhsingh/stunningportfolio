          ...
          >
            <div className="col-span-12">
              <FeaturedProjects
                title="MAP MALL APP"
                img={project2}
                summary="The Mall Map app serves as a navigation tool, specifically designed to assist visitors in locating retail stores within a large mall, utilizing their current location. It is tailored to cater to young adults and middle-aged individuals who value efficiency and wish to minimize the time spent navigating through stores."
